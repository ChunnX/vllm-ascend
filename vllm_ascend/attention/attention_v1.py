    ...
    def update_graph_params(
        ...
        if using_paged_attention(num_tokens, vllm_config):
            ...
            if _EXTRA_CTX.is_draft_model:
                ...
                # by seq_lens_list being non-None.  That also excludes the
                # parallel-drafting draft layers built by
                # AscendFIASinkMetadataBuilder, which leave seq_lens_list None
                # because the sink op is captured inline and re-reads its device
                # inputs on replay, rather than being updated per step here.
                attn_keys = [
