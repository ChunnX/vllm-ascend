...
/*!
 * \file adn_fused_infer_attention_tiling.cc
 * \brief
 */

#include "adn_fused_infer_attention_tiling.h"
#include "adn_fused_infer_attention_tiling_base.h"
#include <vector>
...
ge::graphStatus CustomFIATiling::ConvertContext(gert::TilingContext &context, IncreFlashAttentionContext &ifaContext)
{
    if (context.GetNodeName() == nullptr) {
        OPS_LOG_E("AdnFusedInferAttention", "opName got from TilingContext is nullptr");
        return ge::GRAPH_FAILED;
    }
...
{
    OPS_ERR_IF(context == nullptr, OPS_REPORT_VECTOR_INNER_ERR("AdnFusedInferAttention", "Context is nullptr."),
               return ge::GRAPH_FAILED);
