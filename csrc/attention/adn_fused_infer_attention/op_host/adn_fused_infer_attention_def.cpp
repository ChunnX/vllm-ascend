...
/*!
 * \file adn_fused_infer_attention.cpp
 * \brief
 */
#include "register/op_def_registry.h"

namespace ops {
class AdnFusedInferAttention : public OpDef {
public:
    AdnFusedInferAttention(const char *name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
