...
/*!
 * \file adn_fused_infer_attention_tiling_data.h
 * \brief
 */
...
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(AdnFusedInferAttention, IncreFlashAttentionTilingDataV2)

BEGIN_TILING_DATA_DEF(IncreFlashAttentionTilingAtbDataV2)
TILING_DATA_FIELD_DEF_STRUCT(IncreFlashAttentionBaseParams, tilingBase);
TILING_DATA_FIELD_DEF_STRUCT(IncreFlashAttentionSplitCoreParams, tilingPerCore);
END_TILING_DATA_DEF
REGISTER_TILING_DATA_CLASS(AdnFusedInferAttention_30000000000200000, IncreFlashAttentionTilingAtbDataV2)
REGISTER_TILING_DATA_CLASS(AdnFusedInferAttention_30000000000200001, IncreFlashAttentionTilingAtbDataV2)
