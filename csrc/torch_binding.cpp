...
#include "attention/custom_fused_infer_attention/custom_fused_infer_attention_torch_adpt.h"
#endif
...
TORCH_LIBRARY_EXPAND(CONCAT(_C, _ascend), ops)
{
    ...
    ops.def(
        "npu_custom_fused_infer_attention("
    ...
    ops.impl(
        "npu_custom_fused_infer_attention",
        torch::kPrivateUse1,
        &vllm_ascend::npu_custom_fused_infer_attention);

    ops.def(
        "npu_custom_fused_infer_attention_out("
    ...
    ops.impl(
        "npu_custom_fused_infer_attention_out",
        torch::kPrivateUse1,
        &vllm_ascend::npu_custom_fused_infer_attention_out);
